...
function _set(){_set=_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee2(data){return regenerator_default().wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:return _context2.abrupt("return",chrome.storage.sync.set(data));case 1:case"end":return _context2.stop();}}},_callee2);}));return _set.apply(this,arguments);}function clear(){return _clear.apply(this,arguments);}function _clear(){_clear=_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee3(){return regenerator_default().wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:chrome.storage.sync.clear();case 1:case"end":return _context3.stop();}}},_callee3);}));return _clear.apply(this,arguments);}var Storage={get:get,set:set,clear:clear};/* harmony default export */ var storage = (Storage);
...
;// CONCATENATED MODULE: ./src/extensions/inject.ts
var property;var interval;// Make element draggable
function dragElement(el){var pos1=0,pos2=0,pos3=0,pos4=0;el.onmousedown=dragMouseDown;function dragMouseDown(e){e=e||window.event;e.preventDefault();// get the mouse cursor position at startup:
...
el.style.top=el.offsetTop-pos2+"px";el.style.left=el.offsetLeft-pos1+"px";}function closeDragElement(){// stop moving when mouse button is released:
document.onmouseup=null;document.onmousemove=null;}}function setUp(){var el=document.getElementById("c2u-text");var timeString=calcTime(property.countBy,property.finishDate," ");if(el){el.innerText=timeString;}}// Set update time left interval
function updateTimeLeft(){var intervalSpan=0;switch(property.countBy){case CountType.Day:case CountType.Month:case CountType.Year:case CountType.Week:case CountType.Hour:intervalSpan=1000*60*60;break;case CountType.Minute:intervalSpan=1000*60;break;case CountType.Second:intervalSpan=1000;break;}interval=window.setInterval(setUp,intervalSpan);}function removeUpdateTimeLeft(){window.clearInterval(interval);}// Render the countdown
function render(){return _render.apply(this,arguments);}//Add Google font style tag
function _render(){_render=_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee(){var timeString,backgroundURL,textColor,body,container;return regenerator_default().wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:timeString=calcTime(property.countBy,property.finishDate," ");backgroundURL=property.background.url;textColor=property.textColor;body=document.querySelector("body");container=document.createElement("div");container.id="c2u-container";container.style.backgroundImage="url(".concat(backgroundURL,")");container.style.color=textColor;container.innerHTML="\n        <div>\n            <h1 class=\"c2u-text\" id=\"c2u-text\">".concat(timeString,"</h1>\n        </div>\n    ");dragElement(container);body.insertBefore(container,body.firstChild);case 11:case"end":return _context.stop();}}},_callee);}));return _render.apply(this,arguments);}function addGoogleFontStyle(){var head=document.getElementsByTagName("head")[0];var style=document.createElement("style");style.type="text/css";style.innerHTML="\n        @import url('https://fonts.googleapis.com/css2?family=Lexend+Deca:wght@700;800;900&display=swap');";head.appendChild(style);}function init(){return _init.apply(this,arguments);}function _init(){_init=_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee2(){var _document$getElementB;var config;return regenerator_default().wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:// Remove the countdown if it exists
(_document$getElementB=document.getElementById("c2u-container"))===null||_document$getElementB===void 0?void 0:_document$getElementB.remove();// Remove the update time left interval
removeUpdateTimeLeft();if(!document.getElementById("c2u-app")){_context2.next=4;break;}return _context2.abrupt("return");case 4:config=new Configurations();_context2.next=7;return config.load();case 7:property=config.get();if(!property.isFloatCountdown){_context2.next=12;break;}updateTimeLeft();_context2.next=12;return render();case 12:case"end":return _context2.stop();}}},_callee2);}));return _init.apply(this,arguments);}function changeTextColor(textColor){// change global value
property.textColor=textColor;// change the color of the countdown
var el=document.getElementById("c2u-container");if(el&&el.style.color){el.style.color=textColor;}}if(chrome.runtime){chrome.runtime.onMessage.addListener(function(request,sender,sendResponse){switch(request.eventEmitType){case EventEmitType.ALL:init();break;case EventEmitType.TEXT_COLOR:changeTextColor(request.property.textColor);break;default:break;}sendResponse({data:request.property});});}addGoogleFontStyle();init();
}();
/******/ })()
;
