...
document.addEventListener("mousedown",this.handleClickOutside.bind(this));case 7:case"end":return _context2.stop();}}},_callee2,this);}));function componentDidMount(){return _componentDidMount.apply(this,arguments);}return componentDidMount;}()},{key:"componentWillUnmount",value:function componentWillUnmount(){document.removeEventListener("mousedown",this.handleClickOutside.bind(this));}},{key:"render",value:function render(){return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"p-5 py-0 relative",ref:this.ref,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"flex items-center justify-between relative z-50",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{className:"text-xl font-lexend font-black text-violet-pastel",children:"Countdown2uni"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"flex",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ButtonIcon,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(rotateleft_ForwardRef,{}),id:"btn-restore",onClick:this.restoreData.bind(this)}),/*#__PURE__*/(0,jsx_runtime.jsx)(ButtonIcon,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(bell_ForwardRef,{}),id:"btn-notification",onClick:this.toggleVisibleNotification.bind(this)}),/*#__PURE__*/(0,jsx_runtime.jsx)(LinkIcon,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(settings_ForwardRef,{}),id:"btn-settings",to:"#/settings"})]})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"notification bg-white rounded-2xl w-full p-3 absolute top-0 left-0 shadow-2xl transition-all "+(this.state.isVisibleNotification?"opacity-100 z-40":"opacity-0 z-0"),children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"h-16"}),this.state.notifications.map(function(noti,index){return/*#__PURE__*/(0,jsx_runtime.jsx)(NotiIcon,{title:noti.title,type:noti.type,description:noti.description},index);})]})]});}}]);return HeaderPopup;}(react.Component);
...
//# sourceMappingURL=697.7c3e675d.chunk.js.map